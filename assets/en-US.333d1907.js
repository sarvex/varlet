...
`),a("span",{class:"hljs-keyword"},"const"),s(` {
  errorMessage,
  `),a("span",{class:"hljs-attr"},"validateWithTrigger"),s(`: _validateWithTrigger,
  `),a("span",{class:"hljs-attr"},"validate"),s(`: _validate,
  resetValidation
} = useValidation()
