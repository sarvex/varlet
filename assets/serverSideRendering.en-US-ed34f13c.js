...
`)])],-1),_=s("div",{class:"card"},[s("h3",null,"Example Repository"),s("p",null,[s("a",{href:"https://github.com/varletjs/varlet-install-example/tree/main/nuxt"},"varlet-install-example/nuxt")])],-1);function f(x,y,k,w,b,N){const a=o("var-site-code-example");return r(),p("div",u,[d,s("div",h,[m,v,e(a,{"playground-ignore":""},{default:t(()=>[g]),_:1}),e(a,null,{default:t(()=>[j]),_:1})]),_])}const V=l(i,[["render",f]]);export{V as default};
