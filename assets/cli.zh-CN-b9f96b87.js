...
/zh-CN/changelog
/en-US/changelog
`)],-1),C={class:"card"},V=t("h3",null,"命令相关",-1),R=t("h4",null,"启动开发服务器",-1),S=t("pre",{class:"hljs"},[t("code",null,`varlet-cli dev
`)],-1),k=t("h4",null,"构建文档站点",-1),w=t("pre",{class:"hljs"},[t("code",null,`varlet-cli build
