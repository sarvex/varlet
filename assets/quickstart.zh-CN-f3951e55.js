...
`)])],-1),k=s("div",{class:"card"},[s("h3",null,"在线编辑组件"),s("p",null,[a("我们提供了网页版的组件编辑器，方便您对组件库的各个组件进行快速上手、在线编辑、分享给他人或是下载代码包本地运行。 您可以点击网页右上角的 "),s("code",null,"{...}"),a(" 图标或是 "),s("a",{href:"https://varlet.gitee.io/varlet-ui-playground"},"这里前往"),a("。")])],-1);function w(x,V,b,A,N,C){const n=p("var-site-code-example");return c(),r("div",h,[i,d,s("div",j,[u,_,m,l(n,{"playground-ignore":""},{default:t(()=>[v]),_:1}),g,l(n,{"playground-ignore":""},{default:t(()=>[y]),_:1}),l(n,{"playground-ignore":""},{default:t(()=>[f]),_:1})]),k])}const B=e(o,[["render",w]]);export{B as default};
