...
`)])],-1),_=s("div",{class:"card"},[s("h3",null,"Example Repository"),s("p",null,[s("a",{href:"https://github.com/varletjs/varlet-nuxt3-example"},"varlet-nuxt3-example")])],-1);function f(x,y,k,w,b,N){const e=l("var-site-code-example");return p(),r("div",u,[d,s("div",h,[m,v,a(e,{"playground-ignore":""},{default:t(()=>[g]),_:1}),a(e,null,{default:t(()=>[j]),_:1})]),_])}const V=o(i,[["render",f]]);export{V as default};
