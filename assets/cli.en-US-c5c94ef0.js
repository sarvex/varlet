...
/zh-CN/changelog
/en-US/changelog
`)],-1),C={class:"card"},T=e("h3",null,"Command related",-1),S=e("h4",null,"Start the development server",-1),D=e("pre",{class:"hljs"},[e("code",null,`varlet-cli dev
`)],-1),N=e("h4",null,"Build a documentation site",-1),V=e("pre",{class:"hljs"},[e("code",null,`varlet-cli build
`)],-1),k=e("h4",null,"Preview documentation site",-1),z=e("pre",{class:"hljs"},[e("code",null,`varlet-cli preview
`)],-1),B=e("h4",null,"Compile component library",-1),R=e("pre",{class:"hljs"},[e("code",null,`varlet-cli compile
`)],-1),G={class:"card"},L=e("h3",null,"Run VSCode extension development environment",-1),M=e("pre",{class:"hljs"},[e("code",null,`varlet-cli dev:extension
`)],-1),O={class:"card"},E=e("h3",null,"Build VSCode extension for production",-1),U=e("pre",{class:"hljs"},[e("code",null,`varlet-cli build:extension
`)],-1),A=e("h4",null,"Execute all unit tests",-1),I=e("pre",{class:"hljs"},[e("code",null,`varlet-cli test
`)],-1),P=e("h4",null,"Execute unit tests in watch mode",-1),$=e("pre",{class:"hljs"},[e("code",null,`varlet-cli test -w
or
varlet-cli test -wa
`)],-1),q=e("h4",null,"Lint the code",-1),F=e("pre",{class:"hljs"},[e("code",null,`varlet-cli lint
`)],-1),Q=e("h4",null,"Lint git commit message",-1),W=e("pre",{class:"hljs"},[e("code",null,`varlet-cli commit-lint
...
`)],-1),Y=e("h4",null,"Generate a project template",-1),Z=e("pre",{class:"hljs"},[e("code",null,[d(`varlet-cli gen
...
`)])],-1),ee=e("h4",null,"Create a component template file",-1),te=e("pre",{class:"hljs"},[e("code",null,[d(`varlet-cli create
`),e("span",{class:"hljs-meta"},`
#`),e("span",{class:"bash"}," Options"),d(`
-n
--name
...
--locale
  Need to support internationalization
`)])],-1),oe=e("div",{class:"card"},[e("h3",null,"Note before publish"),e("ul",null,[e("li",null,[d("1."),e("code",null,"npm"),d(" repository registry must set to "),e("code",null,"npm"),d(" official mirror")]),e("li",null,[d("2.Execute "),e("code",null,"npm login"),d(" to log in")])])],-1);function ne(de,le,se,ce,ie,re){const t=c("var-site-code-example");return i(),r("div",h,[u,e("div",p,[m,_,o(t,{"playground-ignore":""},{default:n(()=>[g]),_:1})]),f,e("div",v,[y,b,o(t,{"playground-ignore":""},{default:n(()=>[j]),_:1}),x,o(t,{"playground-ignore":""},{default:n(()=>[w]),_:1})]),e("div",C,[T,S,o(t,{"playground-ignore":""},{default:n(()=>[D]),_:1}),N,o(t,{"playground-ignore":""},{default:n(()=>[V]),_:1}),k,o(t,{"playground-ignore":""},{default:n(()=>[z]),_:1}),B,o(t,{"playground-ignore":""},{default:n(()=>[R]),_:1})]),e("div",G,[L,o(t,{"playground-ignore":""},{default:n(()=>[M]),_:1})]),e("div",O,[E,o(t,{"playground-ignore":""},{default:n(()=>[U]),_:1}),A,o(t,{"playground-ignore":""},{default:n(()=>[I]),_:1}),P,o(t,{"playground-ignore":""},{default:n(()=>[$]),_:1}),q,o(t,{"playground-ignore":""},{default:n(()=>[F]),_:1}),Q,o(t,{"playground-ignore":""},{default:n(()=>[W]),_:1}),H,o(t,{"playground-ignore":""},{default:n(()=>[J]),_:1}),K,o(t,{"playground-ignore":""},{default:n(()=>[X]),_:1}),Y,o(t,{"playground-ignore":""},{default:n(()=>[Z]),_:1}),ee,o(t,{"playground-ignore":""},{default:n(()=>[te]),_:1})]),oe])}const he=s(a,[["render",ne]]);export{he as default};
