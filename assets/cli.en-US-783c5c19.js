...
/zh-CN/changelog
/en-US/changelog
`)],-1),C={class:"card"},S=e("h3",null,"Command related",-1),T=e("h4",null,"Start the development server",-1),k=e("pre",{class:"hljs"},[e("code",null,`varlet-cli dev
...
`)],-1),G=e("h4",null,"Run VSCode extension development environment",-1),L=e("pre",{class:"hljs"},[e("code",null,`varlet-cli dev:extension
`)],-1),M=e("h4",null,"Build VSCode extension for production",-1),O=e("pre",{class:"hljs"},[e("code",null,`varlet-cli build:extension
`)],-1),E=e("h4",null,"Build svg to web fonts",-1),I=e("pre",{class:"hljs"},[e("code",null,`varlet-cli build:icons
`)],-1),P=e("h4",null,"Execute all unit tests",-1),U=e("pre",{class:"hljs"},[e("code",null,`varlet-cli test
`)],-1),A=e("h4",null,"Execute unit tests in watch mode",-1),$=e("pre",{class:"hljs"},[e("code",null,`varlet-cli test -w
or
varlet-cli test -wa
...
--locale
  Need to support internationalization
`)])],-1),oe=e("div",{class:"card"},[e("h3",null,"Note before publish"),e("ul",null,[e("li",null,[d("1."),e("code",null,"npm"),d(" repository registry must set to "),e("code",null,"npm"),d(" official mirror")]),e("li",null,[d("2.Execute "),e("code",null,"npm login"),d(" to log in")])])],-1);function ne(de,le,ce,se,ie,re){const t=s("var-site-code-example");return i(),r("div",h,[u,e("div",p,[m,g,o(t,{"playground-ignore":""},{default:n(()=>[_]),_:1})]),f,e("div",v,[b,y,o(t,{"playground-ignore":""},{default:n(()=>[j]),_:1}),x,o(t,{"playground-ignore":""},{default:n(()=>[w]),_:1})]),e("div",C,[S,T,o(t,{"playground-ignore":""},{default:n(()=>[k]),_:1}),D,o(t,{"playground-ignore":""},{default:n(()=>[N]),_:1}),V,o(t,{"playground-ignore":""},{default:n(()=>[z]),_:1}),B,o(t,{"playground-ignore":""},{default:n(()=>[R]),_:1}),G,o(t,{"playground-ignore":""},{default:n(()=>[L]),_:1}),M,o(t,{"playground-ignore":""},{default:n(()=>[O]),_:1}),E,o(t,{"playground-ignore":""},{default:n(()=>[I]),_:1}),P,o(t,{"playground-ignore":""},{default:n(()=>[U]),_:1}),A,o(t,{"playground-ignore":""},{default:n(()=>[$]),_:1}),q,o(t,{"playground-ignore":""},{default:n(()=>[F]),_:1}),Q,o(t,{"playground-ignore":""},{default:n(()=>[W]),_:1}),H,o(t,{"playground-ignore":""},{default:n(()=>[J]),_:1}),K,o(t,{"playground-ignore":""},{default:n(()=>[X]),_:1}),Y,o(t,{"playground-ignore":""},{default:n(()=>[Z]),_:1}),ee,o(t,{"playground-ignore":""},{default:n(()=>[te]),_:1})]),oe])}const he=c(a,[["render",ne]]);export{he as default};
