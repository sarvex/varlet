import{_ as c,p as r,f as o,h as p,M as a,q as l,S as n,aq as e,P as s}from"./vue-router.esm-bundler.2ed3d3be.js";const d={components:{}},h={class:"varlet-site-doc"},j=a("h1",null,"result",-1),i=a("div",{class:"card"},[a("h3",null,"Intro"),a("p",null,"It is used to show the results to users.")],-1),g={class:"card"},u=a("h3",null,"Basic Use",-1),m=a("pre",{class:"hljs"},[a("code",null,[a("span",{class:"hljs-tag"},[s("<"),a("span",{class:"hljs-name"},"template"),s(">")]),s(`
