import{_ as c,p as e,f as o,h as d,M as a,q as l,S as n,P as s,aq as p}from"./vue-router.esm-bundler-596ad174.js";const r={components:{}},h={class:"varlet-site-doc"},j=a("h1",null,"提示",-1),i=a("div",{class:"card"},[a("h3",null,"介绍"),a("p",null,"当元素点击或悬停时显示一个提示，通过控制弹出位置和偏移量改变提示的显示位置。")],-1),g={class:"card"},m=a("h3",null,"基本使用",-1),u=a("pre",{class:"hljs"},[a("code",null,[a("span",{class:"hljs-tag"},[s("<"),a("span",{class:"hljs-name"},"template"),s(">")]),s(`
