import{_ as e,p as r,f as p,h as o,M as a,q as t,S as n,P as s,as as c}from"./vue-router.esm-bundler.a03b8b02.js";const h={components:{}},d={class:"varlet-site-doc"},j=a("h1",null,"result",-1),i=a("div",{class:"card"},[a("h3",null,"Intro"),a("p",null,"It is used to show the results to users.")],-1),g={class:"card"},m=a("h3",null,"Basic Use",-1),u=a("pre",{class:"hljs"},[a("code",null,[a("span",{class:"hljs-tag"},[s("<"),a("span",{class:"hljs-name"},"template"),s(">")]),s(`
...
`),a("span",{class:"hljs-tag"},[s("</"),a("span",{class:"hljs-name"},"template"),s(">")]),s(`
`)])],-1),f={class:"card"},v=a("h3",null,"Custom Image",-1),b=a("p",null,[s("Customize image through the "),a("code",null,"image"),s(" slot.")],-1),y=a("pre",{class:"hljs"},[a("code",null,[s(`
`),a("span",{class:"hljs-tag"},[s("<"),a("span",{class:"hljs-name"},"template"),s(">")]),s(`
  `),a("span",{class:"hljs-tag"},[s("<"),a("span",{class:"hljs-name"},"var-result"),s(),a("span",{class:"hljs-attr"},"title"),s("="),a("span",{class:"hljs-string"},'"Looping"'),s(),a("span",{class:"hljs-attr"},"description"),s("="),a("span",{class:"hljs-string"},'"\u300AYou Are Not Alone\u300B"'),s(">")]),s(`
    `),a("span",{class:"hljs-tag"},[s("<"),a("span",{class:"hljs-name"},"template"),s(" #"),a("span",{class:"hljs-attr"},"image"),s(">")]),s(`
      `),a("span",{class:"hljs-tag"},[s("<"),a("span",{class:"hljs-name"},"svg"),s(),a("span",{class:"hljs-attr"},"viewBox"),s("="),a("span",{class:"hljs-string"},'"0 0 48 48"'),s(),a("span",{class:"hljs-attr"},"class"),s("="),a("span",{class:"hljs-string"},'"music"'),s(">")]),s(`
        `),a("span",{class:"hljs-tag"},[s("<"),a("span",{class:"hljs-name"},"circle"),s(),a("span",{class:"hljs-attr"},"cx"),s("="),a("span",{class:"hljs-string"},'"24"'),s(),a("span",{class:"hljs-attr"},"cy"),s("="),a("span",{class:"hljs-string"},'"24"'),s(),a("span",{class:"hljs-attr"},"fill"),s("="),a("span",{class:"hljs-string"},'"#37474f"'),s(),a("span",{class:"hljs-attr"},"r"),s("="),a("span",{class:"hljs-string"},'"19"'),s("/>")]),s(`
        `),a("span",{class:"hljs-tag"},[s("<"),a("span",{class:"hljs-name"},"circle"),s(),a("span",{class:"hljs-attr"},"cx"),s("="),a("span",{class:"hljs-string"},'"24"'),s(),a("span",{class:"hljs-attr"},"cy"),s("="),a("span",{class:"hljs-string"},'"24"'),s(),a("span",{class:"hljs-attr"},"fill"),s("="),a("span",{class:"hljs-string"},'"#263238"'),s(),a("span",{class:"hljs-attr"},"r"),s("="),a("span",{class:"hljs-string"},'"18"'),s("/>")]),s(`
        `),a("span",{class:"hljs-tag"},[s("<"),a("span",{class:"hljs-name"},"g"),s(),a("span",{class:"hljs-attr"},"fill"),s("="),a("span",{class:"hljs-string"},'"#37474f"'),s(">")]),s(`
          `),a("span",{class:"hljs-tag"},[s("<"),a("span",{class:"hljs-name"},"path"),s(),a("span",{class:"hljs-attr"},"d"),s("="),a("span",{class:"hljs-string"},'"m41.022 29.815-17.022-5.815 5.815 17.022c5.257-1.796 9.41-5.95 11.207-11.207z"'),s("/>")]),s(`
          `),a("span",{class:"hljs-tag"},[s("<"),a("span",{class:"hljs-name"},"path"),s(),a("span",{class:"hljs-attr"},"d"),s("="),a("span",{class:"hljs-string"},'"m6.978 18.185 17.022 5.815-5.815-17.022c-5.257 1.797-9.41 5.95-11.207 11.207z"'),s("/>")]),s(`
        `),a("span",{class:"hljs-tag"},[s("</"),a("span",{class:"hljs-name"},"g"),s(">")]),s(`
        `),a("span",{class:"hljs-tag"},[s("<"),a("span",{class:"hljs-name"},"path"),s(),a("span",{class:"hljs-attr"},"d"),s("="),a("span",{class:"hljs-string"},'"m24 17c-3.866 0-7 3.134-7 7s3.134 7 7 7 7-3.134 7-7-3.134-7-7-7z"'),s(),a("span",{class:"hljs-attr"},"fill"),s("="),a("span",{class:"hljs-string"},'"#fff"'),s("/>")]),s(`
        `),a("span",{class:"hljs-tag"},[s("<"),a("span",{class:"hljs-name"},"circle"),s(),a("span",{class:"hljs-attr"},"cx"),s("="),a("span",{class:"hljs-string"},'"24"'),s(),a("span",{class:"hljs-attr"},"cy"),s("="),a("span",{class:"hljs-string"},'"24"'),s(),a("span",{class:"hljs-attr"},"r"),s("="),a("span",{class:"hljs-string"},'"1"'),s("/>")]),s(`
      `),a("span",{class:"hljs-tag"},[s("</"),a("span",{class:"hljs-name"},"svg"),s(">")]),s(`
    `),a("span",{class:"hljs-tag"},[s("</"),a("span",{class:"hljs-name"},"template"),s(">")]),s(`
    `),a("span",{class:"hljs-tag"},[s("<"),a("span",{class:"hljs-name"},"template"),s(" #"),a("span",{class:"hljs-attr"},"footer"),s(">")]),s(`
      `),a("span",{class:"hljs-tag"},[s("<"),a("span",{class:"hljs-name"},"var-button"),s(),a("span",{class:"hljs-attr"},"color"),s("="),a("span",{class:"hljs-string"},'"var(--result-question-color)"'),s(),a("span",{class:"hljs-attr"},"text-color"),s("="),a("span",{class:"hljs-string"},'"#fff"'),s(">")]),s("More"),a("span",{class:"hljs-tag"},[s("</"),a("span",{class:"hljs-name"},"var-button"),s(">")]),s(`
    `),a("span",{class:"hljs-tag"},[s("</"),a("span",{class:"hljs-name"},"template"),s(">")]),s(`
  `),a("span",{class:"hljs-tag"},[s("</"),a("span",{class:"hljs-name"},"var-result"),s(">")]),s(`
`),a("span",{class:"hljs-tag"},[s("</"),a("span",{class:"hljs-name"},"template"),s(">")]),s(`

`),a("span",{class:"hljs-tag"},[s("<"),a("span",{class:"hljs-name"},"style"),s(">")]),a("span",{class:"css"},[s(`
`),a("span",{class:"hljs-selector-class"},".music"),s(` {
  `),a("span",{class:"hljs-attribute"},"width"),s(": "),a("span",{class:"hljs-number"},"40vw"),s(`;
  `),a("span",{class:"hljs-attribute"},"animation"),s(": rotate "),a("span",{class:"hljs-number"},"6s"),s(` linear infinite;
}

`),a("span",{class:"hljs-keyword"},"@keyframes"),s(` rotate {
  `),a("span",{class:"hljs-selector-tag"},"from"),s(` {
    `),a("span",{class:"hljs-attribute"},"transform"),s(": "),a("span",{class:"hljs-built_in"},"rotate"),s("("),a("span",{class:"hljs-number"},"0deg"),s(`);
  }

  `),a("span",{class:"hljs-selector-tag"},"to"),s(` {
    `),a("span",{class:"hljs-attribute"},"transform"),s(": "),a("span",{class:"hljs-built_in"},"rotate"),s("("),a("span",{class:"hljs-number"},"360deg"),s(`);
  }
}
`)]),a("span",{class:"hljs-tag"},[s("</"),a("span",{class:"hljs-name"},"style"),s(">")]),s(`
`)])],-1),_={class:"card"},w=c("<h3>Types</h3><p>Result type, optional values are <code>info</code>\uFF0C<code>success</code>\uFF0C<code>warning</code>\uFF0C<code>error</code>\uFF0C<code>question</code>\uFF0C<code>empty</code>.</p>",2),k=a("pre",{class:"hljs"},[a("code",null,[a("span",{class:"hljs-tag"},[s("<"),a("span",{class:"hljs-name"},"script"),s(),a("span",{class:"hljs-attr"},"setup"),s(">")]),a("span",{class:"javascript"},[s(`
