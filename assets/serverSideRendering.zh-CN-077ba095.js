...
`)])],-1),g=s("div",{class:"card"},[s("h3",null,"示例仓库"),s("p",null,[s("a",{href:"https://github.com/varletjs/varlet-nuxt3-example"},"varlet-nuxt3-example")])],-1);function f(x,y,k,w,N,V){const a=o("var-site-code-example");return p(),c("div",i,[h,s("div",d,[m,j,e(a,{"playground-ignore":""},{default:t(()=>[_]),_:1}),e(a,null,{default:t(()=>[v]),_:1})]),g])}const I=l(u,[["render",f]]);export{I as default};
