...
`)])],-1),C=s("h4",null,"Typescript configuration note",-1),B=s("p",null,[n("In order to get good IDE syntax highlighting, please make sure that the type declaration files generated by the above two plugins are include by "),s("code",null,"typescript"),n(", which can be configured as follows in "),s("code",null,"tsconfig.json"),n(":")],-1),S=s("pre",{class:"hljs"},[s("code",null,[n(`{
...
`),s("span",{class:"hljs-tag"},[n("<"),s("span",{class:"hljs-name"},"template"),n(">")]),n(`
  `),s("span",{class:"hljs-tag"},[n("<"),s("span",{class:"hljs-name"},"var-button"),n(" @"),s("span",{class:"hljs-attr"},"click"),n("="),s("span",{class:"hljs-string"},'"handleClick"'),n(">")]),n("Say Hello"),s("span",{class:"hljs-tag"},[n("</"),s("span",{class:"hljs-name"},"var-button"),n(">")]),n(`
`),s("span",{class:"hljs-tag"},[n("</"),s("span",{class:"hljs-name"},"template"),n(">")]),n(`
`)])],-1),M={class:"card"},O=s("h3",null,"File path note",-1),$=s("p",null,[n("In "),s("code",null,"@varlet/ui@2.7.0"),n(" and later versions, we recommend using the following file import method with omitting the suffix to be compatible with "),s("code",null,"js"),n(" and "),s("code",null,"mjs")],-1),E=s("pre",{class:"hljs"},[s("code",null,[s("span",{class:"hljs-keyword"},"import"),n(),s("span",{class:"hljs-string"},"'@varlet/ui/es/style'"),n(`
`)])],-1);function N(T,z,F,L,P,W){const a=o("var-site-code-example");return c(),p("div",i,[h,u,s("div",d,[j,m,l(a,{"playground-ignore":""},{default:t(()=>[g]),_:1}),_,l(a,{"playground-ignore":""},{default:t(()=>[v]),_:1})]),s("div",y,[f,k,l(a,{"playground-ignore":""},{default:t(()=>[w]),_:1}),b,l(a,{"playground-ignore":""},{default:t(()=>[I]),_:1}),x,l(a,{"playground-ignore":""},{default:t(()=>[V]),_:1}),C,B,l(a,{"playground-ignore":""},{default:t(()=>[S]),_:1})]),s("div",R,[U,A,l(a,{"playground-ignore":""},{default:t(()=>[D]),_:1}),H,l(a,{"playground-ignore":""},{default:t(()=>[q]),_:1})]),s("div",M,[O,$,l(a,{"playground-ignore":""},{default:t(()=>[E]),_:1})])])}const J=e(r,[["render",N]]);export{J as default};
