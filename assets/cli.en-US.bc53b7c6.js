...
`)])],-1),_=t("p",null,"Then by simply modifying some basic information of the component library template, you can start the development of the component library",-1),b=o('<h2>Advanced customization</h2><div class="card"><h3>Configuration file</h3><p>The <code>varlet.config.js</code> in the project root directory is used to manage the specific details of the entire component library project</p><table><thead><tr><th>Parameter</th><th>Description</th><th>Type</th><th>Default</th></tr></thead><tbody><tr><td><code>host</code></td><td>Development server host</td><td><em>number</em></td><td><code>localhost</code></td></tr><tr><td><code>port</code></td><td>Development server port</td><td><em>number</em></td><td><code>8080</code></td></tr><tr><td><code>name</code></td><td>Full name of the component library</td><td><em>string</em></td><td><code>Varlet</code></td></tr><tr><td><code>namespace</code></td><td>Component library namespace, Will be used as a component prefix</td><td><em>string</em></td><td><code>var</code></td></tr><tr><td><code>title</code></td><td>The title of the component library in the document</td><td><em>string</em></td><td><code>VARLET</code></td></tr><tr><td><code>logo</code></td><td>The logo of the component library in the document</td><td><em>string</em></td><td><code>-</code></td></tr><tr><td><code>defaultLanguage</code></td><td>Document default language</td><td><em>string</em></td><td><code>zh-CN</code></td></tr><tr><td><code>useMobile</code></td><td>Whether to display the right mobile phone preview</td><td><em>boolean</em></td><td><code>false</code></td></tr><tr><td><code>themes</code></td><td>Document themes</td><td><em>SiteThemes</em></td><td><code>-</code></td></tr><tr><td><code>darkThemes</code></td><td>Document dark mode themes</td><td><em>SiteThemes</em></td><td><code>-</code></td></tr><tr><td><code>highlight</code></td><td>Document code snippet style related</td><td><em>SiteHighlight</em></td><td><code>-</code></td></tr><tr><td><code>analysis</code></td><td>Document statistics related</td><td><em>SiteAnalysis</em></td><td><code>-</code></td></tr><tr><td><code>pc</code></td><td>PC-side document structure configuration</td><td><em>SitePC</em></td><td><code>-</code></td></tr><tr><td><code>mobile</code></td><td>Mobile document structure configuration</td><td><em>SiteMobile</em></td><td><code>-</code></td></tr><tr><td><code>moduleCompatible</code></td><td>Module compatible config</td><td><em>Record&lt;string, string&gt;</em></td><td><code>-</code></td></tr></tbody></table></div>',2),f={class:"card"},y=t("h3",null,"Other Pages",-1),v=t("p",null,[s("If you want to add other pages to the component library, you can write vue components in the creation "),t("code",null,"pages"),s(" folder under the project root directory to generate other pages")],-1),x=t("p",null,"The folder name will be used as a route path, and you can jump to it according to your needs.",-1),w=t("p",null,[s("\u26A0\uFE0F\uFF1AIf there is a conflict between the folder name and the component name, the route will first match the component in "),t("code",null,"pages")],-1),k=t("pre",{class:"hljs"},[t("code",null,`|-- varlet-ui
    ...
    |-- pages
        ...
        |-- contributor
            |-- index.vue
`)],-1),S={class:"card"},T=t("h3",null,"Module Compatible",-1),C=t("p",null,[s("Some external dependencies may need to be compatible with module syntax to achieve the purpose of compiling correctly to "),t("code",null,"commonjs"),s(" and "),t("code",null,"esmodule"),s(". For example, the wording of "),t("code",null,"esmodule"),s(" of "),t("code",null,"dayjs"),s(" is")],-1),D=t("pre",{class:"hljs"},[t("code",null,[t("span",{class:"hljs-keyword"},"import"),s(" dayjs "),t("span",{class:"hljs-keyword"},"from"),s(),t("span",{class:"hljs-string"},"'dayjs/esm'"),s(`
`)])],-1),M=t("p",null,[s("In order to build "),t("code",null,"commonjs"),s(", the writing method is")],-1),V=t("pre",{class:"hljs"},[t("code",null,[t("span",{class:"hljs-keyword"},"import"),s(" * "),t("span",{class:"hljs-keyword"},"as"),s(" dayjs "),t("span",{class:"hljs-keyword"},"from"),s(),t("span",{class:"hljs-string"},"'dayjs'"),s(`
`)])],-1),A=t("p",null,[s("In the project, we embrace the first way of writing the "),t("code",null,"esmodule"),s(" module, and make the following configuration for adaptation")],-1),P=t("pre",{class:"hljs"},[t("code",null,[t("span",{class:"hljs-comment"},"// varlet.config.js"),s(`
...
`)])],-1),B=o('<div class="card"><h3>SiteThemes</h3><p>Theme variables are related, because the default theme variables may be modified from time to time, subject to the theme of the <code>varlet</code> official document</p><table><thead><tr><th>Variable</th></tr></thead><tbody><tr><td><code>color-body</code></td></tr><tr><td><code>color-bar</code></td></tr><tr><td><code>color-sub-bar</code></td></tr><tr><td><code>color-text</code></td></tr><tr><td><code>color-sub-text</code></td></tr><tr><td><code>color-border</code></td></tr><tr><td><code>color-shadow</code></td></tr><tr><td><code>color-introduce-border</code></td></tr><tr><td><code>color-primary</code></td></tr><tr><td><code>color-link</code></td></tr><tr><td><code>color-type</code></td></tr><tr><td><code>color-progress</code></td></tr><tr><td><code>color-progress-track</code></td></tr><tr><td><code>color-side-bar</code></td></tr><tr><td><code>color-side-bar-active-background</code></td></tr><tr><td><code>color-app-bar</code></td></tr><tr><td><code>color-nav-button-hover-background</code></td></tr><tr><td><code>color-mobile-cell-hover</code></td></tr><tr><td><code>color-pc-language-active</code></td></tr><tr><td><code>color-pc-language-active-background</code></td></tr><tr><td><code>color-mobile-language-active</code></td></tr><tr><td><code>color-mobile-language-active-background</code></td></tr><tr><td><code>color-hl-background</code></td></tr><tr><td><code>color-hl-code</code></td></tr><tr><td><code>color-hl-border</code></td></tr><tr><td><code>color-hl-group-a</code></td></tr><tr><td><code>color-hl-group-b</code></td></tr><tr><td><code>color-hl-group-c</code></td></tr><tr><td><code>color-hl-group-d</code></td></tr><tr><td><code>color-hl-group-e</code></td></tr><tr><td><code>color-hl-group-f</code></td></tr><tr><td><code>color-hl-group-g</code></td></tr><tr><td><code>color-hl-group-h</code></td></tr><tr><td><code>color-hl-group-i</code></td></tr></tbody></table></div><div class="card"><h3>SiteHighlight</h3><p>Code snippets are highlighted, based on <a href="https://highlightjs.org/">highlight.js</a></p><table><thead><tr><th>Parameter</th><th>Description</th><th>Type</th><th>Default</th></tr></thead><tbody><tr><td><code>style</code></td><td>highlight css link</td><td><em>string</em></td><td><code>-</code></td></tr></tbody></table></div><div class="card"><h3>SiteAnalysis</h3><p>Statistics related to buried points</p><table><thead><tr><th>Parameter</th><th>Description</th><th>Type</th><th>Default</th></tr></thead><tbody><tr><td><code>baidu</code></td><td>Baidu statistics script address</td><td><em>string</em></td><td><code>-</code></td></tr></tbody></table></div>',3),I={class:"card"},N=t("h3",null,"SitePC, SiteMobile",-1),U=t("p",null,"The document structure is partly related, and the example configuration is as follows",-1),O=t("pre",{class:"hljs"},[t("code",null,[t("span",{class:"hljs-built_in"},"module"),s(`.exports = {
  ...
  `),t("span",{class:"hljs-attr"},"pc"),s(`: {
    ...
    `),t("span",{class:"hljs-attr"},"header"),s(`: {
      ...
      `),t("span",{class:"hljs-attr"},"version"),s(`: {
        `),t("span",{class:"hljs-attr"},"current"),s(": "),t("span",{class:"hljs-string"},"'Vue 3'"),s(`,
        `),t("span",{class:"hljs-attr"},"items"),s(`: {
          `),t("span",{class:"hljs-string"},"'Vue 2'"),s(": "),t("span",{class:"hljs-string"},"'https://varlet-vue2.vercel.app/'"),s(`,
        },
      },
    },
    `),t("span",{class:"hljs-attr"},"indexPage"),s(`: {
      `),t("span",{class:"hljs-attr"},"description"),s(`: {
        `),t("span",{class:"hljs-string"},"'en-US'"),s(": "),t("span",{class:"hljs-string"},"'Varlet is a Material design mobile component library developed based on Vue3'"),s(`,
      },
      `),t("span",{class:"hljs-attr"},"started"),s(`: {
        `),t("span",{class:"hljs-string"},"'en-US'"),s(": "),t("span",{class:"hljs-string"},"'GET STARTED'"),s(`,
      },
    },
...
`)])],-1),E={class:"card"},G=t("h3",null,"Commands Intro",-1),L=t("h4",null,"Start the development server",-1),z=t("pre",{class:"hljs"},[t("code",null,`varlet-cli dev
`)],-1),$=t("h4",null,"Build documentation site",-1),F=t("pre",{class:"hljs"},[t("code",null,`varlet-cli build
`)],-1),R=t("h4",null,"Preview documentation site",-1),H=t("pre",{class:"hljs"},[t("code",null,`varlet-cli preview
`)],-1),W=t("h4",null,"Build component library code",-1),q=t("pre",{class:"hljs"},[t("code",null,`varlet-cli compile
`)],-1),J=t("h4",null,"Perform all unit tests",-1),Q=t("pre",{class:"hljs"},[t("code",null,`varlet-cli test
`)],-1),K=t("h4",null,"Execute unit tests in watch mode",-1),X=t("pre",{class:"hljs"},[t("code",null,`varlet-cli test -w
or
varlet-cli test -wa
`)],-1),Y=t("h4",null,"Lint code",-1),Z=t("pre",{class:"hljs"},[t("code",null,`varlet-cli lint
`)],-1),tt=t("h4",null,"Lint commit message",-1),st=t("pre",{class:"hljs"},[t("code",null,`varlet-cli commit-lint
`)],-1),et=t("h4",null,"Generate changelog",-1),nt=t("pre",{class:"hljs"},[t("code",null,`varlet-cli changelog
`)],-1),lt=t("h4",null,"Release component library",-1),ot=t("pre",{class:"hljs"},[t("code",null,`varlet-cli release
`)],-1),at=t("h4",null,"Generate a project template",-1),ct=t("pre",{class:"hljs"},[t("code",null,[s(`varlet-cli gen [-n | --name[=<componentName>]] [-s | --sfc] [-t | --tsx] [-l | --locale]
`),t("span",{class:"hljs-meta"},`
#`),t("span",{class:"bash"}," Options"),s(`
-n
--name
  Project name
-s
...
`)])],-1),dt=t("h4",null,"Create component template files",-1),rt=t("pre",{class:"hljs"},[t("code",null,[s(`varlet-cli create [-n | --name[=<componentName>]] [-s | --sfc] [-t | --tsx] [-l | --locale]
`),t("span",{class:"hljs-meta"},`
#`),t("span",{class:"bash"}," Options"),s(`
-n
--name
...
`)])],-1),it={class:"card"},ht=t("h3",null,"Babel",-1),pt=t("p",null,[s("To configure "),t("code",null,"babel"),s(", first specify the target browser in "),t("code",null,"package.json")],-1),ut=t("pre",{class:"hljs"},[t("code",null,[s(`{
  `),t("span",{class:"hljs-attr"},'"browserslist"'),s(`: [
    `),t("span",{class:"hljs-string"},'"Chrome >= 51"'),s(`,
    `),t("span",{class:"hljs-string"},'"iOS >= 10"'),s(`
  ]
}
`)])],-1),mt=t("p",null,[s("create "),t("code",null,"babel.config,js")],-1),gt=t("pre",{class:"hljs"},[t("code",null,[t("span",{class:"hljs-comment"},"// babel.config.js"),s(`
`),t("span",{class:"hljs-built_in"},"module"),s(`.exports = {
...
`)])],-1),jt={class:"card"},_t=o("<h3>Git and Npm</h3><h4>Git-hook</h4><p><code>simple-git-hooks</code>, <code>lint-staged</code> cooperate with <code>eslint</code>, <code>stylelint</code>, <code>varlet-cli commit-lint</code> to check before commit, <code>package.json</code> configuration is as follows</p>",3),bt=t("pre",{class:"hljs"},[t("code",null,[s(`{
  `),t("span",{class:"hljs-attr"},'"simple-git-hooks"'),s(`: {
    ...
    `),t("span",{class:"hljs-attr"},'"commit-msg"'),s(": "),t("span",{class:"hljs-string"},'"pnpm exec varlet-cli commit-lint $1"'),s(`
  },
...
`)])],-1),ft=t("p",null,"Mount Git Hooks",-1),yt=t("pre",{class:"hljs"},[t("code",null,`npx simple-git-hooks
`)],-1),vt=t("p",null,[s("create "),t("code",null,".prettierignore")],-1),xt=t("pre",{class:"hljs"},[t("code",null,`// .prettierignore
coverage/**
es/**
umd/**
site/**
...
src/*/__tests__/**
*.md
`)],-1),wt={class:"card"},kt=t("h3",null,"Typescript",-1),St=t("p",null,[s("create "),t("code",null,"tsconfig.json")],-1),Tt=t("pre",{class:"hljs"},[t("code",null,[s(`{
...
`)])],-1),Ct=t("div",{class:"card"},[t("h3",null,"Note before release"),t("ul",null,[t("li",null,"1.The registry of npm must set to the official npm mirror"),t("li",null,"2.The npm must execute the login command for user login")])],-1);function Dt(Mt,Vt,At,Pt,Bt,It){const e=c("var-site-code-example");return d(),r("div",h,[p,t("div",u,[m,g,n(e,{"playground-ignore":""},{default:l(()=>[j]),_:1}),_]),b,t("div",f,[y,v,x,w,n(e,{"playground-ignore":""},{default:l(()=>[k]),_:1})]),t("div",S,[T,C,n(e,{"playground-ignore":""},{default:l(()=>[D]),_:1}),M,n(e,{"playground-ignore":""},{default:l(()=>[V]),_:1}),A,n(e,{"playground-ignore":""},{default:l(()=>[P]),_:1})]),B,t("div",I,[N,U,n(e,{"playground-ignore":""},{default:l(()=>[O]),_:1})]),t("div",E,[G,L,n(e,{"playground-ignore":""},{default:l(()=>[z]),_:1}),$,n(e,{"playground-ignore":""},{default:l(()=>[F]),_:1}),R,n(e,{"playground-ignore":""},{default:l(()=>[H]),_:1}),W,n(e,{"playground-ignore":""},{default:l(()=>[q]),_:1}),J,n(e,{"playground-ignore":""},{default:l(()=>[Q]),_:1}),K,n(e,{"playground-ignore":""},{default:l(()=>[X]),_:1}),Y,n(e,{"playground-ignore":""},{default:l(()=>[Z]),_:1}),tt,n(e,{"playground-ignore":""},{default:l(()=>[st]),_:1}),et,n(e,{"playground-ignore":""},{default:l(()=>[nt]),_:1}),lt,n(e,{"playground-ignore":""},{default:l(()=>[ot]),_:1}),at,n(e,{"playground-ignore":""},{default:l(()=>[ct]),_:1}),dt,n(e,{"playground-ignore":""},{default:l(()=>[rt]),_:1})]),t("div",it,[ht,pt,n(e,{"playground-ignore":""},{default:l(()=>[ut]),_:1}),mt,n(e,{"playground-ignore":""},{default:l(()=>[gt]),_:1})]),t("div",jt,[_t,n(e,{"playground-ignore":""},{default:l(()=>[bt]),_:1}),ft,n(e,{"playground-ignore":""},{default:l(()=>[yt]),_:1}),vt,n(e,{"playground-ignore":""},{default:l(()=>[xt]),_:1})]),t("div",wt,[kt,St,n(e,{"playground-ignore":""},{default:l(()=>[Tt]),_:1})]),Ct])}const Ut=a(i,[["render",Dt]]);export{Ut as default};
