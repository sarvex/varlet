...
`)],-1),B=t("h4",null,"启动 VSCode 插件开发环境",-1),q=t("pre",{class:"hljs"},[t("code",null,`varlet-cli dev:extension
`)],-1),E=t("h4",null,"构建 VSCode 插件",-1),L=t("pre",{class:"hljs"},[t("code",null,`varlet-cli build:extension
`)],-1),M=t("h4",null,"打包字体图标",-1),O=t("pre",{class:"hljs"},[t("code",null,`varlet-cli build:icons
