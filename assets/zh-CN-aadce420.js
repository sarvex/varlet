...
`)])],-1),_={class:"card"},v=s("h3",null,"函数绑定",-1),b=s("p",null,"指针悬停和离开时会触发函数，并携带当前的悬停状态。",-1),f=s("pre",{class:"hljs"},[s("code",null,[s("span",{class:"hljs-tag"},[a("<"),s("span",{class:"hljs-name"},"script"),a(),s("span",{class:"hljs-attr"},"setup"),a(">")]),s("span",{class:"javascript"},[a(`
...
`)]),s("span",{class:"hljs-tag"},[a("</"),s("span",{class:"hljs-name"},"style"),a(">")]),a(`
`)])],-1),y={class:"card"},x=s("h3",null,"针对不同设备选择性启用",-1),k=s("p",null,[a("考虑到在不同平台的 "),s("code",null,"hover"),a(" 效果的差异性，悬停指令可以只启用于特定的平台。")],-1),V=s("h4",null,"只在桌面端启用",-1),w=s("pre",{class:"hljs"},[s("code",null,[s("span",{class:"hljs-tag"},[a("<"),s("span",{class:"hljs-name"},"var-paper"),a(),s("span",{class:"hljs-attr"},"v-hover:desktop"),a("="),s("span",{class:"hljs-string"},`"{ color: '#fff' }"`),a('">')]),a("HOVER"),s("span",{class:"hljs-tag"},[a("</"),s("span",{class:"hljs-name"},"var-paper"),a(">")]),a(`
...
`)])],-1);function $(N,O,R,Y,B,C){const l=c("var-site-code-example");return p(),r("div",o,[i,j,s("div",u,[d,m,n(l,null,{default:t(()=>[g]),_:1})]),s("div",_,[v,b,n(l,null,{default:t(()=>[f]),_:1})]),s("div",y,[x,k,V,n(l,{"playground-ignore":""},{default:t(()=>[w]),_:1}),H,n(l,{"playground-ignore":""},{default:t(()=>[E]),_:1})])])}const q=e(h,[["render",$]]);export{q as default};
