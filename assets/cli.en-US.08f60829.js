...
/zh-CN/changelog
/en-US/changelog
`)],-1),C={class:"card"},k=e("h3",null,"Command related",-1),T=e("h4",null,"Start the development server",-1),S=e("pre",{class:"hljs"},[e("code",null,`varlet-cli dev
...
`)])],-1),ne=e("p",null,[t("In the project, we embrace the first way of writing the "),e("code",null,"esmodule"),t(" module, and make the following configuration for adaptation")],-1),le=e("pre",{class:"hljs"},[e("code",null,[e("span",{class:"hljs-comment"},"// varlet.config.mjs"),t(`
...
`)])],-1);function de(se,ce,ae,re,ie,he){const o=c("var-site-code-example");return a(),r("div",h,[p,e("div",u,[m,g,n(o,{"playground-ignore":""},{default:l(()=>[_]),_:1})]),f,e("div",y,[v,b,n(o,{"playground-ignore":""},{default:l(()=>[j]),_:1}),w,n(o,{"playground-ignore":""},{default:l(()=>[x]),_:1})]),e("div",C,[k,T,n(o,{"playground-ignore":""},{default:l(()=>[S]),_:1}),D,n(o,{"playground-ignore":""},{default:l(()=>[N]),_:1}),z,n(o,{"playground-ignore":""},{default:l(()=>[M]),_:1}),R,n(o,{"playground-ignore":""},{default:l(()=>[V]),_:1}),B,n(o,{"playground-ignore":""},{default:l(()=>[G]),_:1}),I,n(o,{"playground-ignore":""},{default:l(()=>[L]),_:1}),O,n(o,{"playground-ignore":""},{default:l(()=>[E]),_:1}),U,n(o,{"playground-ignore":""},{default:l(()=>[A]),_:1}),P,n(o,{"playground-ignore":""},{default:l(()=>[$]),_:1}),q,n(o,{"playground-ignore":""},{default:l(()=>[F]),_:1}),Q,n(o,{"playground-ignore":""},{default:l(()=>[W]),_:1}),H,n(o,{"playground-ignore":""},{default:l(()=>[J]),_:1})]),K,e("div",X,[Y,Z,n(o,{"playground-ignore":""},{default:l(()=>[ee]),_:1}),te,n(o,{"playground-ignore":""},{default:l(()=>[oe]),_:1}),ne,n(o,{"playground-ignore":""},{default:l(()=>[le]),_:1})])])}const ue=s(i,[["render",de]]);export{ue as default};
