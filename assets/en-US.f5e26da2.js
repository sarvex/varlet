...
`)])],-1);function v(b,k,y,f,T,x){const l=o("var-site-code-example");return c(),r("div",p,[i,d,s("div",m,[j,e(l,{"playground-ignore":""},{default:n(()=>[u]),_:1}),_,e(l,{"playground-ignore":""},{default:n(()=>[g]),_:1})])])}const S=t(h,[["render",v]]);export{S as default};
