...
`)])],-1),S={class:"card"},D=t("h3",null,"Offset",-1),P=t("p",null,[s("The offset of the Tooltip popup can be set with "),t("code",null,"offset-x"),s(" and "),t("code",null,"offset-y")],-1),C=t("pre",{class:"hljs"},[t("code",null,[t("span",{class:"hljs-tag"},[s("<"),t("span",{class:"hljs-name"},"template"),s(">")]),s(`
  ...
  `),t("span",{class:"hljs-tag"},[s("</"),t("span",{class:"hljs-name"},"var-tooltip"),s(">")]),s(`
`),t("span",{class:"hljs-tag"},[s("</"),t("span",{class:"hljs-name"},"template"),s(">")]),s(`
`)])],-1),B={class:"card"},U=t("h3",null,"Trigger",-1),V=t("p",null,[s("Use "),t("code",null,"trigger"),s(" to change the trigger method of tooltip display, the optional values are "),t("code",null,"click"),s(" and "),t("code",null,"hover")],-1),z=t("pre",{class:"hljs"},[t("code",null,[t("span",{class:"hljs-tag"},[s("<"),t("span",{class:"hljs-name"},"template"),s(">")]),s(`
  ...
  `),t("span",{class:"hljs-tag"},[s("</"),t("span",{class:"hljs-name"},"var-tooltip"),s(">")]),s(`
`),t("span",{class:"hljs-tag"},[s("</"),t("span",{class:"hljs-name"},"template"),s(">")]),s(`
`)])],-1),E={class:"card"},N=t("h3",null,"Events",-1),O=t("pre",{class:"hljs"},[t("code",null,[t("span",{class:"hljs-tag"},[s("<"),t("span",{class:"hljs-name"},"script"),s(),t("span",{class:"hljs-attr"},"setup"),s(">")]),t("span",{class:"javascript"},[s(`
...
`)])],-1),I={class:"card"},$=t("h3",null,"Disabled",-1),A=t("p",null,[s("In the "),t("code",null,"disabled"),s(" state, the tooltip will no longer be opened.")],-1),M=t("pre",{class:"hljs"},[t("code",null,[t("span",{class:"hljs-tag"},[s("<"),t("span",{class:"hljs-name"},"template"),s(">")]),s(`
  ...
  `),t("span",{class:"hljs-tag"},[s("</"),t("span",{class:"hljs-name"},"var-tooltip"),s(">")]),s(`
`),t("span",{class:"hljs-tag"},[s("</"),t("span",{class:"hljs-name"},"template"),s(">")]),s(`
`)])],-1),q={class:"card"},H=t("h3",null,"Two-way binding",-1),R=t("p",null,[s("Two-way binding control tooltip show and hide via "),t("code",null,"v-model:show")],-1),W=t("pre",{class:"hljs"},[t("code",null,[t("span",{class:"hljs-tag"},[s("<"),t("span",{class:"hljs-name"},"script"),s(),t("span",{class:"hljs-attr"},"setup"),s(">")]),t("span",{class:"javascript"},[s(`
`),t("span",{class:"hljs-keyword"},"import"),s(" { ref } "),t("span",{class:"hljs-keyword"},"from"),s(),t("span",{class:"hljs-string"},"'vue'"),s(`
