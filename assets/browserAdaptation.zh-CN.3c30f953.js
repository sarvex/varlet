...
`)])],-1);function y(N,V,k,C,$,B){const n=l("var-site-code-example");return c(),p("div",h,[i,u,s("div",_,[m,t(n,{"playground-ignore":""},{default:o(()=>[j]),_:1}),t(n,{"playground-ignore":""},{default:o(()=>[v]),_:1})]),s("div",x,[g,f,t(n,{"playground-ignore":""},{default:o(()=>[b]),_:1}),t(n,{"playground-ignore":""},{default:o(()=>[w]),_:1})])])}const P=e(d,[["render",y]]);export{P as default};
