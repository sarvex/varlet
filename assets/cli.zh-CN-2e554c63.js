...
`)],-1),B={class:"card"},q=t("h3",null,"启动 VSCode 插件开发环境",-1),E=t("pre",{class:"hljs"},[t("code",null,`varlet-cli dev:extension
`)],-1),L={class:"card"},M=t("h3",null,"构建 VSCode 插件",-1),O=t("pre",{class:"hljs"},[t("code",null,`varlet-cli build:extension
`)],-1),A=t("h4",null,"执行所有的单元测试",-1),P=t("pre",{class:"hljs"},[t("code",null,`varlet-cli test
`)],-1),D=t("h4",null,"以 watch 模式执行单元测试",-1),F=t("pre",{class:"hljs"},[t("code",null,`varlet-cli test -w
or
varlet-cli test -wa
`)],-1),G=t("h4",null,"检查代码",-1),H=t("pre",{class:"hljs"},[t("code",null,`varlet-cli lint
`)],-1),I=t("h4",null,"校验提交信息",-1),J=t("pre",{class:"hljs"},[t("code",null,`varlet-cli commit-lint
